# AGENTS.md - GDG ID Platform

Guidance for AI agents and humans working in this repository.

## Read order (every session)

1. [docs/state.md](docs/state.md) - operating position (Operate)
...
- Read docs/DEPLOY.md before suggesting Cloud Run or env changes.
- Prefer existing About-page credits over inventing new attribution.
